									...
									<div class="blog-external">
										<div class="media">
											<div class="item head-button">
												<div class="media-lefts so-block">
													...
													<img  class="media-object lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>assets/frontend/image/demo/blog/1.jpg" alt="Kire tuma demonstraverunt lector">
													</a>
												</div>
										...
										<div class="media">
											<div class="item head-button">
												<div class="media-lefts so-block">
													<a href="blog-detail.html" target="_blank">
													<img class="media-object lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>assets/frontend/image/demo/blog/4.jpg" alt="Neque porro quisquam est, lore">
													</a>
												</div>
												<div class="media-body">
										...
										<div class="media">
											<div class="item head-button">
												<div class="media-lefts so-block">
													<a href="blog-detail.html" target="_blank">
													<img class="media-object lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>assets/frontend/image/demo/blog/3.jpg" alt="Ac tincidunt Suspendisse malesu">
													</a>
												</div>
												<div class="media-body">
													<div class="media-content so-block">
