									...
									<div class="spcat-wrap ">
										...
										<div class="main-left">
											<div class="banner-post-text">
												 <a href="#" title="banner"> <img class="lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?= base_url() ?>assets/frontend/image/demo/banner/s1.jpg" alt="banner">  </a>                        				
											</div>
																...
																<div class="item-inner product-thumb product-item-container transition ">
																	<div class="left-block">
																		<div class="product-image-container">
																			<div class="image">
																			   	<a class="lt-image" href="product.html" target="_self" title="Verty nolen max..">
																					<img  src="<?= base_url() ?>assets/frontend/image/demo/shop/product/t3.jpg" alt="Apple Cinema 30" title="Emdcu meagi" class="img-1 img-responsive" />
																					<img  src="<?= base_url() ?>assets/frontend/image/demo/shop/product/t3.jpg" alt="Apple Cinema 30" title="Emdcu meagi" class="img-2 img-responsive" />
																				</a>
																			</div>			
																		</div>
																		<span class="label label-sale">Sale</span>
