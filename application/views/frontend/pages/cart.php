          ...
          <h2 class="title">Shopping Cart</h2>
            <div class="table-responsive form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td class="text-center"><a href="product.html"><img width="70px" src="<?= base_url() ?>assets/frontend/image/demo/shop/product/E3.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" class="img-thumbnail" /></a></td>
                  ...
                  <tr>
                    <td class="text-center"><a href="product.html"><img width="70px" src="<?= base_url() ?>assets/frontend/image/demo/shop/product/E1.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail" /></a></td>
